    ...
    <section className="mb-[100px] md:mb-[50px]">
      ...
      <aside className="flex flex-col items-center">
        <div className="flex flex-row w-full items-center justify-evenly">
          <Tooltip title="Baixar currículo em PDF" arrow>
            <CustomButtom
              onClick={() =>
                "window.location.href='https://drive.google.com/file/d/14AeRbMWZeQypZVXNpSMieRyv9o3-2L_1/view?usp=share_link'"
              }
            >
              <a
      ...
      <article className="md:grid md:grid-cols-2 my-[40px] md:mt-[100px] md:mb-[50px] px-[12px] md:px-0">
        <aside className="md:col-span-1 text-white">
          <h2 className="font2 text-tertiary-main text-[30px] font-bold text-center md:text-left md:px-[75px] py-[18px] md:py-0">
            Bio
          </h2>
        </aside>
      ...
      <article className="md:grid md:grid-cols-2 my-[40px] md:my-[100px] px-[12px] md:px-0">
        <aside className="col-span-1 text-white ">
          <h2 className="font2 text-primary-main text-[30px] font-bold text-center md:text-left md:px-[75px] py-[24px] md:py-0">
            Habilidades
          </h2>
        </aside>
          ...
          {skills.map((el) => (
            <>
              <div className="flex flex-row md:flex-col justify-between md:justify-start row-span-1 md:col-span-1 mb-[30px] md:mb-0">
                <h4 className="uppercase font1 md:text-[20px] text-secondary-main font-bold">
                  {el.skillArea}
                </h4>
                <ul className="text-white font1 md:mt-[20px]">
                  {el.array.map((skill, index) => (
                    <li
                      key={index}
                      className="pb-[5px] text-[18px] text-right md:text-left"
                    >
                      {skill}
                    </li>
                  ))}
              ...
              <div className="bg-tertiary-main h-[1px] w-full my-[25px] md:hidden" />
            </>
          ))}
        </aside>
      </article>

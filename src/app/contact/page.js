    ...
    <section className="">
      ...
      >
        <h2 className="font2 text-white text-[18px] md:text-[38px] pt-[20px] md:py-[40px] font-bold text-center md:px-[150px]">
          mailto:{" "}
          <p className="inline text-primary-main hover:cursor-default hover:text-my-pink-100 duration-150 text-[20px] md:text-[38px]">
            ...
            >
              ...
              >
                ...
                <input
                  ...
                  className="font-normal text-[16px] font1 py-[5px] my-[5px] text-gray-700 pl-[10px] border-[1px] border-b-[4px] border-primary-main focus:border-my-pink-100 focus:ring-my-pink-100"
                  type="text"
                  name="contact-name"
                  id="contact-name"
                />

import {
  ...
  aga6,
  aga7,
} from "../assets/portfolio/aga-site/exports";
...
import {
  ...
  mu6,
  mu7,
} from "../assets/portfolio/mercado-unido/exports";
import {
  teia1,
  teia2,
  teia3,
  ...
  teia8,
  teia9,
} from "../assets/portfolio/teia-exp/exports";
import {
  bot1,
  bot2,
  bot3,
  bot4,
  bot5,
} from "../assets/portfolio/usain-bot/exports";
import {
  events1,
  events2,
  events3,
...
const projectsGallery = [
  ...
  },
  {
    ...
    stacks: ["react", "tailwind", "axios", "materialui"],
  },
  {
    name: "site | mercado unido",
    description:
      'Essa plataforma começou a ser desenvolvida para um cliente com uma ideia de MVP voltado para a venda no varejo. Projeto reproduzido a partir de protótipo criado no Figma. Site com cards promocionais, formulários de informações e contato, integração com Firebase para autenticação por contas existentes e um layout de "quebra-cabeça" na Home, algo que foi um desafio interessante a ser ultrapassado. Toda a plataforma foi desenvolvida pelo método "mobile first", ou seja, é totalmente responsiva.',
    imageGallery: [mu1, mu2, mu3, mu4, mu5, mu6, mu7],
  ...
  },
  {
    ...
    description:
      "Essa landing page foi desenvolvida para a empresa AGA Tecnologia em cima de um estudo feito sobre landing Pages, com o intuito de informar sobre o produto e atrair possíveis leads, deixando o acesso bem prático - a um QR CODE de distância.",
    singlePage: true,
    imageGallery: [land1, land2, land3],
    link: "",
  ...
  },
  {
    ...
    description:
      "Esse website foi desenvolvido para a empresa AGA Tecnologia, com o intuito de apresentar um pouco mais sobre a empresa e seus membros de uma forma simples e descontraída, seus produtos e serviços, além de links para contato. ",
    singlePage: true,
    imageGallery: [aga1, aga2, aga3, aga4, aga5, aga6, aga7],
